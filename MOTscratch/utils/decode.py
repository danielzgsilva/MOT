...
from .model_utils import _gather_feat, _tranpose_and_gather_feat
from .model_utils import _nms, _topk, _topk_channel
...
def generic_decode(output, K=100, opt=None):
    ...
    # max pool predicted heat map of confidences
    heat = _nms(heat)
